...
export default {
	async execute(interaction) {
		...
		await interaction.editReply({ embeds: [new EmbedBuilder({ color: 0x0000a5, description: fact })] });
	},
	slashCommand: new SlashCommandBuilder().setName("fact").setDescription("Tells you an interesting fact.")
};